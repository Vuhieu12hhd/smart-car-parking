        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="apartment_number" value="<?php echo $row['apartment_number']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="license_plate" value="<?php echo $row['license_plate']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
